...
# Разговорные синонимы/команды -> алиас статуса.
TASK_STATUS_SYNONYMS: Final[dict[str, str]] = {
    "на паузу": "paused",
    "приостанови": "paused",
    "пауза": "paused",
    "не время": "paused",
    "пока не делаем": "paused",
    "не сейчас": "paused",
    "отложи": "paused",
    "ожидание": "waiting",
    "жду": "waiting",
    "ждем ответа": "waiting",
    "на согласовании": "waiting",
}

# Нормализация статуса из свободного текста (RU/EN).
TASK_STATUS_NORMALIZATION: Final[dict[str, str]] = {
    **{k.lower(): v for k, v in TASK_STATUS_ALIASES.items()},
